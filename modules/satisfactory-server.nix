  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.satisfactory = {
      ...
      preStart = ''
        ...
        ${pkgs.crudini}/bin/crudini --set /var/lib/satisfactory/SatisfactoryDedicatedServer/FactoryGame/Saved/Config/LinuxServer/Engine.ini '/Script/OnlineSubsystemUtils.IpNetDriver' NetServerMaxTickRate ${toString cfg.tickRate}
        ${pkgs.crudini}/bin/crudini --set /var/lib/satisfactory/SatisfactoryDedicatedServer/FactoryGame/Saved/Config/LinuxServer/Engine.ini '/Script/OnlineSubsystemUtils.IpNetDriver' LanServerMaxTickRate ${toString cfg.tickRate}
        ${pkgs.crudini}/bin/crudini --set /var/lib/satisfactory/SatisfactoryDedicatedServer/FactoryGame/Saved/Config/LinuxServer/Engine.ini '/Script/SocketSubsystemEpic.EpicNetDriver' NetServerMaxTickRate ${toString cfg.tickRate}
        ${pkgs.crudini}/bin/crudini --set /var/lib/satisfactory/SatisfactoryDedicatedServer/FactoryGame/Saved/Config/LinuxServer/Engine.ini '/Script/SocketSubsystemEpic.EpicNetDriver' LanServerMaxTickRate ${toString cfg.tickRate}
        ${pkgs.crudini}/bin/crudini --set /var/lib/satisfactory/SatisfactoryDedicatedServer/FactoryGame/Saved/Config/LinuxServer/Engine.ini '/Script/Engine.Engine' NetClientTicksPerSecond ${toString cfg.tickRate}
